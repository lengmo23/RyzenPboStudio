...
# 包内顶层目录固定不带版本号：手动下载新包解压时能直接盖在既有安装目录上，
# 而不是留下两个版本各一份的文件夹。自动更新不依赖该名字
# （Updater.ExtractAndVerify 是靠找到主程序 exe 来定位根目录的）。
$folderName = 'AMDRyzenPBOStudio'
